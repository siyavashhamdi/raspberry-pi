  ...
  constructor() {
    ...
    this.device = {
      output: {
        ...
        rigGrpA: new GPIO(6, 'high'),
        rigGrpB: new GPIO(5, 'high'),
        mainBoard: new GPIO(26, 'high'),
      },
      input: {
        motionDetectionA: new GPIO(26, 'in', 'rising'), // new GPIO(13, 'in', 'rising', { debounceTimeout: 10 }),
      },
    };
  }
